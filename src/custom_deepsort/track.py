...
class TrackState:
    ...
    Tentative:
        A newly created track that is not reliable yet.

    Confirmed:
        A stable track that has been matched enough times.

    Deleted:
        A track that should be removed from the tracker.
    """
...
class Track:
    ...
    def _update_feature(self, new_feature: np.ndarray):
        ...
        # Normalize the feature for cosine-distance comparison.
